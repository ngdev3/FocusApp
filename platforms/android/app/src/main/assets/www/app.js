...
var project_name_val = "/focus";
var project_name = project_name_val + '/webservices/Webapi';
var app_url = base_url + project_name;
var payment_url = base_url + project_name_val
...
// var project_name_val = "/Projects2018/pioneer";
// var project_name = project_name_val + '/webservices/Webapi';
// var app_url = base_url + project_name;
// var payment_url = base_url + project_name_val
...
var image_url = base_url + project_name_val + '/uploads/profile_image/'
...
app.run(function ($rootScope, $cookieStore, loading, model, $http, $location, $interval) {
   ...
   if(base_url != 'http://192.168.31.199'){
